...
namespace TTSHWeb
{
    public partial class SearchBox : System.Web.UI.UserControl
    {
        ...
        public enum FilterCriteria { FEASIBALITY, ETHICS, SELECTED, REGULATORY, GRANT, CONTRACT, ALLPROJECTS }
        ...
        public void searchText()
        {
            ...
            try
            {
                ...
                Dictionary<string, Search[]> dictSearch = proxy.GetSearchData(SearchInputValue, SearchFilterCriteria.ToString());

...
<style type="text/css">
    ...
    .labelError {font-family:Verdana, Geneva, sans-serif; height:18px;border:none; font-size:11px;color:red;max-width :200px;overflow:hidden }
...
<table class="tableSearch">
    <tr>
        ...
        <tr>
            <td class="tdBorder" >
                <asp:TextBox ID="txtSearch" runat="server" AutoPostBack="false" CssClass="tSearch" onkeypress="return blockSpecialChar(event)" onblur="Blur(this)" onfocus="Focus(this)"  AutoCompleteType="Disabled"></asp:TextBox>
        ...
        <tr>
            <td class="tdSearchButtons">
                ...
                <asp:LinkButton ID="btnExport" runat="server" Text="Export To Excel" OnClick="btnExport_Click" CssClass="SearchButtons"/>
            </td>
        </tr>
</table>
